...
// onePhone.guardaEnArchivo()
// newProductManager.updateProduct(1, {title:199})

const twoPhone = new ProductManager( "Iphone", "14 PLUS","plateado", 1500, "im2g", 4, 2)
const onePhone = new ProductManager("Samsung", "22 ULTRA", 1000, "hola", "img", 3, 4)